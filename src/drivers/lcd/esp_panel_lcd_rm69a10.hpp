...
/**
 * @brief LCD driver class for RM69A10 display controller
 *
 */
class LCD_RM69A10: public LCD {
public:
    /**
     * @brief Default basic attributes for RM69A10 LCD controller
     */
     ...
     */
    LCD_RM69A10(Bus *bus, int width, int height, int color_bits, int rst_io):
     ...
     */
    LCD_RM69A10(Bus *bus, const Config &config):
     ...
     * @note Vendor initialization commands may vary between manufacturers. Consult LCD supplier for them
     */
    LCD_RM69A10(const BusFactory::Config &bus_config, const Config &lcd_config):
     ...
     */
    [[deprecated("Use other constructor instead")]]
    LCD_RM69A10(Bus *bus, uint8_t color_bits = 0, int rst_io = -1): LCD_RM69A10(bus, 0, 0, color_bits, rst_io)
    {
    }
...
/**
 * @brief Alias for backward compatibility
 * @deprecated Use `esp_panel::drivers::LCD_RM69A10` instead
 */
using ESP_PanelLcd_RM69A10 [[deprecated("Use `esp_panel::drivers::LCD_RM69A10` instead")]] =
    esp_panel::drivers::LCD_RM69A10;
